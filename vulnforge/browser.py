                        ...
                        try:
                            ...
                            try:
                                ...
                                resp = await page.goto(
                                    test_url, timeout=timeout * 1000, wait_until="domcontentloaded"
                                )
                                if not resp:
                                    continue
                                ...
                                if payload in content and any(
                                    sink in content for sink in DOM_SINKS
                                ):
                                    findings.append(
                                        {
                                            "url": url,
                                            "payload": payload,
                                            "evidence": "Payload reflected near DOM sink",
                                            "type": "dom_xss",
                                        }
                                    )
