...
PHASE_CATEGORIES: Dict[str, Dict[str, Any]] = {
    ...
    "AI & Advanced Testing": {
        "desc": "LLM prompt injection, business logic bypass, SSO/federation attacks, Electron security, supply chain, modern protocols",
        "phases": [
            ("149-LLMSEC", "LLM prompt injection testing"),
            ("150-LLMLEAK", "LLM system prompt leakage detection"),
            ("151-RAGPOISON", "RAG context poisoning probes"),
            ("152-LLMADV", "LLM tool calling abuse & advanced attacks"),
            ("153-BIZLOGIC", "Workflow logic bypass & state machine violations"),
            ("154-PAYMENT", "Payment logic bypass & price manipulation"),
            ("155-COUPON", "Coupon/discount abuse testing"),
            ("156-MTENANT", "Multi-tenant isolation testing"),
            ("157-2FA", "2FA/CAPTCHA bypass testing"),
            ("158-SSO", "OIDC/OAuth misconfiguration testing"),
            ("159-SAMLADV", "SAML assertion manipulation"),
            ("160-SSOCONF", "Cross-tenant token confusion & IdP spoofing"),
            ("161-ELECTRON", "Electron security config audit"),
            ("162-ELECTRONRCE", "Electron RCE probe (openExternal, openPath)"),
            ("163-ELECTRONPROTO", "Electron protocol handler hijack"),
            ("164-ELECTRONUPD", "Electron auto-updater security"),
            ("165-DEPCONF", "Dependency confusion testing"),
            ("166-TYPOSQUAT", "Typo-squatting detection"),
            ("167-H2RAPID", "HTTP/2 Rapid Reset (CVE-2023-44487)"),
            ("168-H3QUIC", "HTTP/3 & QUIC attack surface"),
            ("169-WEBTRANSPORT", "WebTransport endpoint discovery"),
        ],
    },
}
...
WIZARD_PRESETS: Dict[str, Dict[str, Any]] = {
    ...
    "full": {
        "name": "Full Audit",
        "desc": "All 185 phases — complete recon + vuln scan + auth + client-side + infra + CMS + AI + business logic + advanced (~2.5 hrs)",
        "phases": VALID_PHASES,
        "defaults": {
            "delay": 0.0,
            "rate_limit": 10,
...
class PipelineConfig:
    ...
    def __post_init__(self) -> None:
        ...
        _positive_int = [
            ...
            "sample_urls_fuzz",
            "sample_urls_params",
            "sample_urls_arjun_waf",
            "sample_hosts_ssl",
            "sample_hosts_origin",
            "sample_endpoints_l",
            "sample_urls_xss_blind",
            "sample_urls_ssti",
            "sample_endpoints_post",
            "sample_endpoints_cors",
            "sample_hosts_cloud",
            "sample_hosts_git",
            "sample_hosts_graphql",
            "sample_hosts_waf",
            "sample_urls_nosqli",
            "sample_endpoints_race",
            "sample_hosts_jwt",
            "sample_urls_xxe",
            "sample_urls_cmdi",
            "sample_endpoints_sspp",
            "sample_hosts_cached",
            "sample_urls_depcheck",
            "sample_urls_redirect",
            "sample_hosts_clickjack",
            "sample_urls_crlf",
            "sample_hosts_ratelimit",
            "sample_endpoints_ratelimit",
            "sample_endpoints_corsadv",
            "sample_hosts_jwtadv",
            "sample_urls_upload",
            "sample_hosts_smuggle",
            "sample_endpoints_oauth",
            "sample_endpoints_pwreset",
            "sample_hosts_websocket",
            "sample_urls_ldap",
            "sample_endpoints_deserial",
            "sample_urls_lfi",
            "sample_urls_idor",
            "sample_urls_apisec",
            "sample_urls_domxss",
            "sample_hosts_h2smuggle",
            "sample_hosts_frameworks",
            "sample_urls_csrf",
            "sample_hosts_sessionfix",
            "sample_endpoints_saml",
            "sample_users_spray",
            "sample_hosts_cookie",
            "sample_urls_posttest",
            "sample_urls_methodoverride",
            "sample_hosts_forcedbrowse",
            "sample_urls_casebypass",
            "sample_urls_apipage",
            "sample_urls_tabnab",
            "sample_urls_apikeyleak",
            "sample_urls_redirabuse",
            "sample_urls_logtrigger",
            "sample_urls_xssstored",
            "sample_hosts_hostabuse",
            "sample_urls_authbypassadv",
            "sample_urls_ssi",
            "sample_urls_jsoninject",
            "sample_urls_nullbyte",
            "sample_urls_doubleencod",
            "sample_urls_unicode",
            "sample_hosts_postmsg",
            "sample_hosts_jsonp",
            "sample_hosts_sri",
            "sample_hosts_mixedcontent",
            "sample_hosts_hstspreload",
            "sample_hosts_thirdpartyjs",
            "sample_hosts_browserstorage",
            "sample_urls_rfi",
            "sample_hosts_webdav",
            "sample_hosts_snmp",
            "sample_hosts_banner",
            "sample_hosts_phpinfo",
            "sample_hosts_srvstatus",
            "sample_urls_errorleak",
            "sample_hosts_wildcarddns",
            "sample_hosts_dnsrebind",
            "sample_hosts_iisaspnet",
            "sample_hosts_tomcat",
            "sample_hosts_nodejs",
            "sample_hosts_laravel",
            "sample_hosts_django",
            "sample_hosts_symfony",
            "sample_hosts_cicd",
            "sample_hosts_docker",
            "sample_hosts_k8s",
            "sample_hosts_terraform",
            "sample_hosts_envdeep",
            "sample_hosts_gqlabuse",
            "sample_urls_apiversion",
            "sample_hosts_lbdetect",
            "sample_hosts_vhost",
            "sample_urls_ratelimitbypass",
            "sample_hosts_emailfinder",
            "sample_urls_metagoofil",
            "sample_hosts_porchpirate",
            "sample_urls_dorkhunter",
            "sample_hosts_crtsh",
            "sample_hosts_githubsub",
            "sample_hosts_tlsx",
            "sample_hosts_analyticsrels",
            "sample_hosts_favirecon",
            "sample_urls_jsluice",
            "sample_urls_shortscan",
            "sample_hosts_grpcurl",
        ...
        if self.proxy_timeout_multiplier <= 0:
            raise ConfigError(
                f"proxy_timeout_multiplier must be > 0, got {self.proxy_timeout_multiplier}"
            )
        if self.waf_evasion_throttle < 0:
            raise ConfigError(f"waf_evasion_throttle must be >= 0, got {self.waf_evasion_throttle}")
        if (
            isinstance(self.proxy, str)
            and self.proxy
            and not self.proxy.startswith(
                ("http://", "https://", "socks4://", "socks4a://", "socks5://", "socks5h://")
            )
        ):
            raise ConfigError(
                f"proxy must start with http://, https://, socks4://, socks4a://, socks5://, or socks5h://, got {self.proxy!r}"
            )
        if (
            isinstance(self.vuln_proxy, str)
            and self.vuln_proxy
            and not self.vuln_proxy.startswith(
                ("http://", "https://", "socks4://", "socks4a://", "socks5://", "socks5h://")
            )
        ):
            raise ConfigError(
