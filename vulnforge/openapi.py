"""OpenAPI 3.0 specification generator for VulnForge REST API.

Generates and serves the OpenAPI specification for API documentation,
client generation, and Swagger UI integration.

Usage:
    from vulnforge.openapi import get_spec, generate_spec_file
    spec = get_spec()
...
<html>
<head>
    <title>VulnForge API - Swagger UI</title>
...
<html>
<head>
    <title>VulnForge API - Documentation</title>
